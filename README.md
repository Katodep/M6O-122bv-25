## Цели работы
- Освоение базовых приёмов работы с файлами в Python
- Сохранение и загрузка данных между запусками программы
- Закрепление объектно-ориентированного подхода
- Реализация файловой СУБД с единым интерфейсом доступа к данным
